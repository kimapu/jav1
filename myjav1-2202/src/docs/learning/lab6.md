...
2.	Consider the UML diagram in Figure 6.1. Write a program that demonstrate Movable interface and MovablePoint and  MovableCircle classes. State any assumption for your program.

3.	Modify the Lab 5-Q3, according to the UML diagram in Figure 6.2. Write a test program called TestResizableCircle to test the method defined in ResizeableCircle. 
